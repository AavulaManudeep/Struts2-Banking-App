...
<div class="card-group">
 ...
 <div class="col-sm-4">
  <div class="card">
    <div class="card-body"  class="single">
      <s:label value="Your Expenditure" ></s:label>
  ...
  <div class="card">
    <div class="card-body" class="single">
    <s:label value="Transactions" ></s:label>
      <s:form cssClass="form1">
      <s:textfield name="username" label="Username" placeholder="UserName" cssClass="card_2" ></s:textfield>
      <s:textfield name="deletaccount" label="Account Number" placeholder="Account Number"  cssClass="card_2"></s:textfield>
